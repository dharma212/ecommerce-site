...
#   path('wishlist/ajax/toggle/', ToggleWishlistView.as_view(), name='toggle-wishlist-ajax'),
    ...
    path("wishlist/move-to-cart/",MoveWishlistToCartView.as_view(),name="move_wishlist_to_cart"),
    ...
    path('clear-coupon-popup/', ClearCouponPopupView.as_view(), name='clear_coupon_popup'),
