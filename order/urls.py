...
from .views import CheckoutView, MyOrdersView, OrderDetailView, PaymentView, OrderStatusView, ReOrderView,CancelOrderView,InvoiceDownloadView, FeedbackCreateView
urlpatterns = [
