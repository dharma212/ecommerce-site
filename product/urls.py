...
urlpatterns = [
    ...
    path("view-product/<int:pk>/", ProductDetailView.as_view(), name="product_detail"),
    path('download-excel/',ProductExcelDownloadView.as_view(),name="download_excel"),

    # path("product/view/<int:idProductDetailViewProductView.as_view(),name="product_view")
